...
public class UmlDesigner extends javax.swing.JFrame implements PropertyChangeListener{
    ...
    */
    ...
    private void initComponents() {
        ...
        jEditorPane1.setText("<!DOCTYPE html> <!-- Copyright 2023 Moe.  Licensed under the Apache License, Version 2.0 (the \"License\"); you may not use this file except in compliance with the License. You may obtain a copy of the License at       http://www.apache.org/licenses/LICENSE-2.0  Unless required by applicable law or agreed to in writing, software distributed under the License is distributed on an \"AS IS\" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License. --> <html>     <head>         <title>Waiting4Godot </title>         <meta charset=\"UTF-8\">         <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">     </head>     <body>         <div><h1>Waiting4Godot User Manual</h1></div>                  <div><h2>The model</h2></div>                           <div><h2>Using the tool</h2></div>         <div><h3>Diagrams</h3></div>                           <div><h4>Use Case Diagram</h4></div>         <div><p>Supports the following elements: Actor, Use Case and Association.</p></div>                  <div><h5>Control Level</h5></div>         <div>             <p>                 Use Case Diagrams are not constrained.             </p>         </div>                  <div><h5>Grouping Elements</h5></div>         <div>             <p>                 Use Packages to group Use Cases & Actors.             </p>         </div>                  <div><h5>Objects</h5></div>         <div>             <p>             Objects identified while constructing the diagram may be captured as follows:             </p>             <ul>                 <li>Business Objects can be captured in Use Case elements.</li>                 <li>Controllers can be captured in Actor elements.</li>             </ul>                         <p>                 Its also possible to link Objects captured in other elements.             </p>         </div>                          <div><h5>Attached Diagrams</h5></div>         <div>             <p>                 Its possible to catalog further analysis of certain Elements by                  creating Attached Diagrams. Elements created in these Attached Diagrams                 are available for use elsewhere in the model. The following Elements support                 Attached Diagrams.                                 </p>                             <ul>                 <li>Use Case</li>             </ul>            </div>                                    <div><h4>Activity Diagram</h4></div>         <div><p>Supports the following elements: Activity (Action, Call Activity,                  Accept Event, Accept Time Event, Send Signal) , Activity Node (Start, Stop,Flow End)                  & Control Node (Conditional Block, While Loop & Repeat Loop).</p></div>                  <div><h5>Control Level</h5></div>         <div>             <p>                 Use Case Diagrams may be free or constrained.             </p>             <ul>                                 <li>Free: Suitable mode for high level analysis to help identify and capture Objects, properties & methods.                 </li>                 <li>Constrained. Only methods of Objects captured in other diagrams can be used as Activities.</li>             </ul>         </div>                  <div><h5>Grouping Elements</h5></div>         <div>             <p>                 Use swimlanes to group Use Cases & Actors.             </p>         </div>                  <div><h5>Objects</h5></div>         <div>             <p>             Objects identified while constructing the diagram may be captured as follows:             </p>             <ul>                 <li></li>                 <li>C</li>             </ul>                         <p>                              </p>         </div>                          <div><h5>Attached Diagrams</h5></div>         <div>             <p>                                                </p>                             <ul>                 <li></li>             </ul>            </div>                                    <div><h4>Sequence Diagram</h4></div>         <div><p>Supports the following elements: Actor, Message.</p></div>                  <div><h5>Control Level</h5></div>         <div>             <p>                 Sequence Diagrams may be free or constrained.             </p>             <ul>                                 <li>Free: Suitable mode for high level analysis to help identify and capture Objects, properties & methods.                 </li>                 <li>Constrained. Objects captured in other diagrams can be used as Actors. Only Object Messages can be used as Messages.</li>             </ul>         </div>                  <div><h5>Grouping Elements</h5></div>         <div>             <p>                 Use Packages to group Messages.             </p>         </div>                  <div><h5>Objects</h5></div>         <div>             <p>             Objects identified while constructing the diagram may be captured as follows:             </p>                          <p>                 Its also possible to link Objects captured in other elements.             </p>         </div>                          <div><h5>Attached Diagrams</h5></div>         <div>             <p>                 Its possible to catalog further analysis of certain Elements by                  creating Attached Diagrams. Elements created in these Attached Diagrams                 are available for use elsewhere in the model. The following Elements support                 Attached Diagrams.                                 </p>                         </div>                           <div><h4>Package Diagram</h4></div>                           <div><h4>Class Diagram</h4></div>              </body> </html> ");
