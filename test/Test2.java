    ...
    list.setDropTarget(new DropTarget(list, TransferHandler.COPY, new DropTargetAdapter() {
      private void print(Transferable tr) {
        try {
          ...
          System.out.println(node.getClass()); // I want the actual object
          System.out.println(((Object[])node)[0]); // I want the actual object
          System.out.println(((Object[])node).length + " members"); // I want the actual object
          System.out.println(((DefaultMutableTreeNode)((Object[])node)[0]).getUserObject());
